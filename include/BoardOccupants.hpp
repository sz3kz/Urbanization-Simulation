...
class BoardOccupants : public Board<CellOccupant>
{
  public:
    ...
    [[nodiscard]] auto checkCellEmptyAtCoordinates(Coordinates const& coordinates) const -> bool;
    ...
    [[nodiscard]] auto getCellBuildingType(Coordinates const& coordinates) const -> BuildingType;
